...
import 'package:miasuperadmin/lib/Screens/Sign%20Up/Controller/signup_%20controller.dart';
          ...
          child: Form(
            ...
            child: Column(
              children: [
                SizedBox(height: 20,),
                Text('Sign Up',
                  style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold),),     SizedBox(height: 20,),
                    ...
                    onPressed: () {
                      if (_formKey.currentState!.validate()) {
                        ...
                        signupController.signUpApi(
                          firstName:
                              signupController.adminFirstNameController.text,
                          lastName:
                              signupController.adminLastNameController.text,
                          cnic: signupController.adminCnicController.text,
                          address: signupController.adminAddressController.text,
                          mobileno:
                              signupController.adminMobileNoController.text,
                          password:
                              signupController.adminPasswordController.text,file: signupController.file
                        );
                      }
                    },
                    horizontalPadding: 8,
